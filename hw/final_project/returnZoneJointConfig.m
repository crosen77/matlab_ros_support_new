...
function [start_q] = returnZoneJointConfig(zoneInspect)
    ...
    elseif strcmp(zoneInspect, "Zone4")
        ...
        %start_q = [-0.35    0.400    1.35000   -1.8223   -0.0001 -0.1865]; %could work well but has getObjectData issue
        start_q = [-0.1865    0.3000    1.5000   -1.8223   -0.0001   -0.1865];
